The clustering in first procedure is done in Weka.
The remaining procedure is done by the code. 
Note: The file directories in "source" and "read_table" function in the code need to be changed when you try to run the code.
